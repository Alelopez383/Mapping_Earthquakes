...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  // Retrieve for major earthquake and style it the same as earthquake data
...
majorEQ.addTo(map);
  ...
  // Data for default line
  let defaultLineData = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
  ...
  d3.json(defaultLineData).then(function(data) {
    console.log(data);
